...
image1 = Image.open('/home/user/wyf/train_multimodal_from_scratch/test_images/th1.png').convert("RGB")
image2 = Image.open('/home/user/wyf/train_multimodal_from_scratch/test_images/th2.png').convert("RGB")
